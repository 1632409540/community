alter table user  change gmt_create create_date timestamp null default null on update current_timestamp comment '创建时间';
...
alter table question  change gmt_create create_date timestamp null default null on update current_timestamp comment '创建时间';
...
alter table notification  change gmt_create create_date timestamp null default null on update current_timestamp comment '创建时间';
...
alter table comment  change gmt_create create_date timestamp null default null on update current_timestamp comment '创建时间';
